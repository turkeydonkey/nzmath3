...
class FinitePrimeFieldElementTest(unittest.TestCase):
    ...
    def testMul(self):
        ...
        self.assertTrue(isinstance(residue1 * residue2, FinitePrimeFieldElement))
    ...
    def testDiv(self):
        ...
        self.assertTrue(isinstance(zero.__div__(one), FinitePrimeFieldElement))
        self.assertTrue(isinstance(zero.__truediv__(one), FinitePrimeFieldElement))
    ...
    def testSub(self):
        ...
        self.assertTrue(isinstance(residue1 - 2, FinitePrimeFieldElement))
        self.assertTrue(isinstance(1 - residue2, FinitePrimeFieldElement))

    def testInverse(self):
        residue1 = FinitePrimeFieldElement(8, 151)
        self.assertTrue(isinstance(residue1.inverse(), FinitePrimeFieldElement))
...
class FinitePrimeFieldTest(unittest.TestCase):
    ...
    def testGetInstance(self):
        ...
        self.assertTrue(FinitePrimeField.getInstance(17) is FinitePrimeField.getInstance(17))
...
class FiniteExtendedFieldElementTest (unittest.TestCase):
    ...
    def testTrace(self):
        ...
        self.assertTrue(a3.trace() in self.F3, repr(a3.trace()))
...
class FiniteExtendedFieldTest (unittest.TestCase):
    ...
    def testSuperring(self):
        ...
        self.assertTrue(F125.issuperring(F5))

    def testSuperringGlobal(self):
        import nzmath.rational as rational
        F125 = FiniteExtendedField(5, 3)
        self.assertFalse(F125.issuperring(rational.theRationalField))
        self.assertFalse(F125.issuperring(rational.theIntegerRing))
