...
###############################################################################
# def createModule(self, pair_mat_repr, base=None, ishnf=False):
#     if base == 0: #Z[theta]
#         module.Module(pair_mat_repr, self.getRing(), ishnf)
#     elif base == 1: #integral bases
#         module.Module(pair_mat_repr, self.getRing(),
#            self.integral_ring(), ishnf)
#     else:
#         module.Module(pair_mat_repr, self.getRing(), base, ishnf)
# def different(self):
#      inv_different = Ideal(
#          [Ideal._inverse_different(self.field), 1], self.field)
#     return self.(int_basis)discriminant() * inv_different.inverse()
###############################################################################
